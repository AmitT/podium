...
Building the theme requires [node.js](http://nodejs.org/download/). We recommend you update to the latest version of NPM: [`npm i -g npm`](https://docs.npmjs.com/try-the-latest-stable-version-of-npm).
