...
define ('PODIUM_SMUSH_SUFFIX', '/plugins/wp-smushit/'); // required for loading the plugin from the podium folder

// example code for loading plugins through a theme:
/*
...
$smush_constants = array(
	...
	'DIR'               => get_template_directory()."/".PODIUM_SMUSH_SUFFIX,
	//'URL'               => plugin_dir_url( __FILE__ ),
	'URL'               =>  get_template_directory_uri().PODIUM_SMUSH_SUFFIX,
	'MAX_BYTES'         => 1000000,
